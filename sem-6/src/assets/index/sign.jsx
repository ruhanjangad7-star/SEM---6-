...
import { getCurrentUser, signup } from "./authStore";
    ...
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-white to-gray-50">
      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 lg:grid-cols-2 lg:items-center">
        <section className="space-y-4">
          <p className="text-sm font-semibold uppercase tracking-wider text-red-700">Create Account</p>
          <h1 className="text-4xl font-extrabold leading-tight text-gray-900 sm:text-5xl">
            Join NEXAIRE LAPTOPS And Shop by Real Need
          </h1>
          <p className="max-w-lg text-sm text-gray-600 sm:text-base">
            Create your account to save cart, manage profile, and track all orders with status.
          </p>
          <div className="rounded-2xl border border-red-100 bg-red-50 px-4 py-3 text-sm text-red-700">
            Fast signup with secure password-based account access.
          </div>
        </section>

        <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
          <h2 className="text-2xl font-bold text-gray-900">Sign Up</h2>
          <p className="mt-1 text-sm text-gray-600">Fill your details to create an account.</p>
